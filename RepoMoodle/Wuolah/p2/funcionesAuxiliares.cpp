...
void ed::consultarDatosDeProvincia(ed::Provincia &provincia)
{
	...
	{
		cout << BIRED << "La provincia esta vacia" << RESET << endl;
		return;
	}

	if(provincia.hayMunicipios()==true)
	{
		cout << BIYELLOW << "Nombre: " << RESET << provincia.getNombre() << endl;
		cout << BIYELLOW << "Codigo: " << RESET << provincia.getCodigo() << endl;
		cout << BIBLUE << "Numero de municipios: " << RESET << provincia.getNumeroMunicipios() << endl;
		cout << BIBLUE << "Total de hombres: " << RESET << provincia.getTotalHombres() << endl;
		cout << BIBLUE << "Total de mujeres: " << RESET << provincia.getTotalMujeres() << endl;
		cout << BIBLUE << "Total de habitantes: " << RESET << provincia.getTotalHabitantes() << endl;
	}
	else{
		cout << BIYELLOW << "Provincia: " << RESET << provincia.getNombre() << endl;
		cout << BIYELLOW << "Codigo: " << RESET << provincia.getCodigo() << endl;
		cout << BIRED << "ERROR, la provincia esta vacia " << RESET << endl;
	}
	return;
}
