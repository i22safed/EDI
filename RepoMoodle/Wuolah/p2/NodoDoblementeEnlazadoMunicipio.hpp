...
*/
	inline NodoDoblementeEnlazadoMunicipio(const Municipio& item, NodoDoblementeEnlazadoMunicipio* previous, NodoDoblementeEnlazadoMunicipio* next)
  {
		this->setItem(item);
...
*/
	inline Municipio const & getItem()  const
	{
 		return this->_item;
	}
...
/*!
	...
	\return void
*/
	void setItem(Municipio const & item)
	{
		_item = item;
