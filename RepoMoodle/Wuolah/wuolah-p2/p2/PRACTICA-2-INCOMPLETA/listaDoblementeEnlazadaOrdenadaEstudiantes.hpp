...
*/
	...
	inline ed::NodoDoblementeEnlazadoEstudiante * getHead() const{ return this->_head; }
...
*/
	...
	inline ed::NodoDoblementeEnlazadoEstudiante * getCurrent() const{ return this->_current; }
...
*/
	inline bool isEmpty() const{
		if (this->_head == NULL && this->_current == NULL){ return true; }
		else{ return false; }
...
/*!
	...
	\sa getCurrentItem, gotoHead, isLastItem
      */
...
/*!
	...
	\sa find, isEmpty, isLastItem, isFirstItem, gotoHead
*/
...
/*!
	...
	\sa find, isEmpty, isLastItem, isFirstItem
*/
	void remove();
...
/*!		
	...
	\param  l: objeto de tipo ListaDoblementeEnlazadaOrdenadaEstudiantes
	\post   El objeto actual es igual al parámetro
	\return Devuelve un puntero a sí mismo
*/
	ListaDoblementeEnlazadaOrdenadaEstudiantes &operator=(const ListaDoblementeEnlazadaOrdenadaEstudiantes &l);
