...
/*!
	...
	\attention Todos los metdodos son definidos como "inline"
*/
...
const ed::Estudiante & getItem()  const{ return this->_item; }
...
*/
	NodoDoblementeEnlazadoEstudiante  *getPrevious() const { return this->_previous; }
...
*/
	...
	NodoDoblementeEnlazadoEstudiante  *getNext() const{ return this->_next; }
...
/*!	
	...
	\return void
*/
	void setItem(ed::Estudiante const & item) { this->_item  = item; }		
...
/*!	
	...
	\return void
*/
	void setPrevious(NodoDoblementeEnlazadoEstudiante  *previous) {	this->_previous = previous;}
...
/*!	
  ...
  \return void
*/
	void setNext(NodoDoblementeEnlazadoEstudiante  *next) {	this->_next = next; }
