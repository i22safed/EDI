...
*/
	...
	/*
	El constructor de ListaDoblementeEnlazadaOrdenadaEstudiantes asigna los valores NULL a la cabeza y al cursor de _lista
	*/
	}
...
/*!		
	...
	\sa     estaVacia
*/
	inline  int getNumeroEstudiantes() const{return _lista.nItems();}
...
/*!		
	...
	\param  indice indica el orden alfabetico del arbol
...
*/
	inline  void setNombre(std::string const & nombre){_nombre=nombre;}
...
/*!		
	...
	\return void
*/
	inline void setEstudiante(ed::Estudiante const &e){_lista.setCurrentItem(e);}
