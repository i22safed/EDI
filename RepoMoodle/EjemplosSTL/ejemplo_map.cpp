...
typedef  map <int,int,less<int> > tipo_map;
...
int main()
{
 ...
 for (i = 0; i < 10; i++)
  v1.insert(tipo_map::value_type(i%4,i+1));
 ...
 //
  if (v1.empty())
    cout << "El map v1 está vacío" << endl;
  else
    cout << "El map v1 no está vacío" << endl;


  cout << "La longitud máxima del map de enteros v1 es: " << v1.max_size() << endl;

  cout << "La longitud actual del map de enteros v1 es: " << v1.size() << endl;

  cout << "La longitud actual del map de enteros v2 es: " << v2.size() << endl;
 ...
 for (int i = 0; i < 10; i++)
  v2.insert(tipo_map::value_type(i/4,i+1));
 ...
 cout << endl;
  ...
  cout << "\n La longitud actual del map de enteros v1 es: " << v1.size() << endl;
 ...
 cout << endl;
  ...
  v1.insert(v1.begin(), tipo_map::value_type(0,1));
 ...
 for (int i = 0; i < 10; i++)
  v2.insert(tipo_map::value_type(i,2*i));
 ...
 //////////////////////////////////////////////////////////////
  ...
  v1.clear();
  for (int i = 0; i < 10; i++)
   v1.insert(tipo_map::value_type(i,i));
  ...
  cout << "\n find" << endl;
  cout << "\n p = find(v1.begin(),v1.end(),tipo_map::value_type(3,3));" << endl;
  p = find(v1.begin(),v1.end(),tipo_map::value_type(3,3));
  ...
  cout << "\n p = find(v1.begin(),v1.end(),tipo_map::value_type(-1,-1));" << endl;
  p = find(v1.begin(),v1.end(),tipo_map::value_type(-1,-1));
 ...
 cout << endl;
  ...
  v1.insert(tipo_map::value_type(0,0));
 ...
 cout << "\n binary_search(v1.begin(),v1.end(),tipo_map::value_type(3,3)) " << endl;

  if (binary_search(v1.begin(),v1.end(),tipo_map::value_type(3,3)))
   cout << " El elemento (3,3) se encuentra en el contenedor " << endl;



  cout << "\n  p = lower_bound(v1.begin(),v1.end(),tipo_map::value_type(3,3)); " << endl;
  cout << "\n  p1 = upper_bound(v1.begin(),v1.end()tipo_map::value_type(3,3));" << endl; 

  p = lower_bound(v1.begin(),v1.end(),tipo_map::value_type(3,3));
  p1 = upper_bound(v1.begin(),v1.end(),tipo_map::value_type(3,3));
 ...
 cout << endl;
  ...
  pair <tipo_map::iterator,tipo_map::iterator> par; 

  cout << "\n  par = equal_range(v1.begin(),v1.end(),3); " << endl;
  par = equal_range(v1.begin(),v1.end(),tipo_map::value_type(3,3));
 ...
 v1.clear();
 for (int i = 0; i < 10; i++)
  v1.insert(tipo_map::value_type(i,i/4));
 ...
 cout << endl;
  ...
  cout << "\n Uso de count para contar las apariciones de (1,1) --> "  
       << count(v1.begin(),v1.end(),tipo_map::value_type(1,1)) 
       << " veces " << endl;
 ...
 v2.clear();
 for (int i = 0; i < 10; i++)
  v2.insert(tipo_map::value_type(i,i%4));
